...
* virtual PixelFormat Format {get;}
* virtual int PixelWidth {get;}
* virtual int PixelHeight {get;}
* virtual double DpiX {get;}
* virtual double DpiY {get;}
...
* virtual event EventHandler<DownloadProgressEventArgs> DownloadProgress {add; remove;}
* virtual event EventHandler<ExceptionEventArgs> DownloadFailed {add; remove}
* virtual event EventHandler<ExceptionEventArgs> DecodeFailed {add; remove;}
